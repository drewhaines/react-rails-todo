...
import * as uiActions from '../../actions/redux-auth/ui';
import * as emailSignInActions from '../../actions/redux-auth/email-sign-in';
import * as emailSignUpActions from '../../actions/redux-auth/email-sign-up';
import * as signOutActions from '../../actions/redux-auth/sign-out';
import * as requestPasswordResetActions from '../../actions/redux-auth/request-password-reset';
import * as oAuthSignInActions from '../../actions/redux-auth/oauth-sign-in';
import * as updatePasswordActions from '../../actions/redux-auth/update-password';
import * as destroyAccountActions from '../../actions/redux-auth/destroy-account';
import * as updatePasswordModalActions from '../../actions/redux-auth/update-password-modal';
import * as serverActions from '../../actions/redux-auth/server';
